...
const InvoiceLevel3Approval = () => {
  ...
  const handleApprove = async () => {
    ...
    const jsonBody = {
      ...
      level3ApprovedBy: userId,
      level3Remarks: remarks,
      level3ApprovedOn: formattedDate,
    };
    // console.log("data- " + JSON.stringify(jsonBody));

    const responseApproval = await transporterService.InvoiceUpdateLevel3Status(
      jsonBody
    );
    // console.log("data- " + JSON.stringify(responseApproval));
  ...
  const handleReject = async () => {
    ...
    if (remarks.length === 0) {
      ...
      const responseApproval =
        await transporterService.InvoiceUpdateLevel3Status(jsonBody);
...
export default InvoiceLevel3Approval;
