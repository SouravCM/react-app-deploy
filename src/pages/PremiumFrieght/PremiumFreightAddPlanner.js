...
const PremiumFreightAddPlanner = () => {
  ...
  async function getFreightApprovalLevel1() {
    ...
    let freightList = await FreightServices.getFreightListPending(requestBody);
    ...
    if (freightList.code === 200) {
      ...
      materialsArray.map((freight, index) => {
        ...
        if (freight.level1Status === "APPROVED") {
          level2Count++;
        }
  ...
  const addFreight = async (e) => {
    ...
    let FreightAddResponse = await FreightServices.addPremiumFreight(
      freightJson
    );
    console.log("Add Freight Response:" + JSON.stringify(FreightAddResponse));
    if (FreightAddResponse.code === 200) {
      console.log("Successfully Added ");
      setDialogTitleMessage("Premium Freight  Added  Successfully");
  ...
  return (
    <Grid container style={containerStyle}>
      <h3 style={{ marginLeft: "8px" }}>Premium Freight Module</h3>
      <Grid item xs={12} style={ItemStyle}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={2}>
                <TextField
                  ...
                  onChange={(e) => setDateCalender(e.target.value)}
                />
              </Grid>
              <Grid item xs={2}>
                <TextField
        ...
        <Grid item xs={12}>
          ...
          >
            <h3 style={{ padding: "12px" }}>List of Premium Freights</h3>
            <table
              style={{
          ...
          <div style={{ height: 400, width: "100%", overflow: "scroll" }}>
            <DataGrid
              ...
              columns={columns}
              pageSize={10}
              columnVisibilityModel={{ freightData: false }}
...
export default PremiumFreightAddPlanner;
